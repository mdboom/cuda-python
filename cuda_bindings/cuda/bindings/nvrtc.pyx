...
# This code was automatically generated with version 13.3.0, generator version 0.3.1.dev1717+g3685a988f. Do not modify it directly.
...
def nvrtcGetErrorString(result not None : nvrtcResult):
    ...
    """
    cdef cynvrtc.nvrtcResult cyresult = int(result)
    with nogil:
...
def nvrtcGetTileIRSize(prog):
    ...
    with nogil:
        err = cynvrtc.nvrtcGetTileIRSize(cyprog, &TileIRSizeRet)
    if err != cynvrtc.NVRTC_SUCCESS:
        return (_nvrtcResult(err), None)
